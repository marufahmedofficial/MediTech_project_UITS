    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            Text('Swipe right to full view', style: boldTextStyle())
                .paddingBottom(3),
                    ...
                    .map(
                      (data) => DataRow(
                        cells: [
                          ...
                          DataCell(
                              Text(data.phone!, style: secondaryTextStyle())),
                          DataCell(
                              Text(data.address!, style: secondaryTextStyle())),
                        ],
                      ),
                    )
                    .toList(),
